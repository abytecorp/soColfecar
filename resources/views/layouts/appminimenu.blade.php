            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="{{ route('planofull.miniapp') }}"  aria-expanded="false"><i class="icon-notebook"></i><span class="hide-menu">Plano </span></a>
                            {{-- <ul aria-expanded="false" class="collapse">
