    ...
    <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div v-if="isNew">
                        <form v-on:submit.prevent="storePlan">
                            ...
                            <div class="form-group">
                                <FloatingLabel
                                    :config="{label: 'Agenda Academica', hasError: false, hasClearButton: false }">
                                    <input name="planAcadAgenda" type="number" id="planAcadAgenda" v-model="newPlan.academic_agenda" >
                                </FloatingLabel>
                            ...
                            <div class="form-group">
                                <FloatingLabel
                                    :config="{label: 'Hospedaje', hasError: false, hasClearButton: false }">
                                    <input name="planHost" type="number" id="planHost" v-model="newPlan.host" >
                                </FloatingLabel> 
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody v-if="eventId">
                            <tr v-for="plan in plans" :key="plan.id" v-bind:class="{'table-warning' : plan.edit}">
                                ...
                                <td class="text-center"><div v-if="!plan.edit">{{ plan.refreshment || 'NO' }}</div><div v-else><input type="number" v-model="plan.refreshment"></div></td>
                                <td class="text-center"><div v-if="!plan.edit">{{ plan.host || 'NO' }}</div><div v-else><input type="number" v-model="plan.host"></div></td>
